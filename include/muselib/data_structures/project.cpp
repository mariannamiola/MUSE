...
bool ProjectMeta::read(const std::string filename)
{
    return readConfFileJSON(filename);
}

bool ProjectMeta::write(const std::string filename)
{
    return writeConfFileJSON(filename);
}

bool ProjectMeta::readConfFileJSON(const std::string filename)
{
#ifdef MUSE_USES_CEREAL
    std::ifstream ss (filename.c_str(), std::ifstream::in);
...
bool ProjectMeta::writeConfFileJSON (const std::string filename, const int &precision)
{
#ifdef MUSE_USES_CEREAL
    std::ofstream ss (filename.c_str(), std::ofstream::out);
