...
then
	...
	export DATA_SOURCE=${MUSE}/examples/13_RISL_grid/data
fi
...
for ((n=1; n<=3; n++))
do
    mv ${OUTSURF}/${GEOM}_${n}.obj ${OUTSURF}/${GEOM}_${n}_tri.obj
    mv ${OUTSURF}/${GEOM}_${n}.json ${OUTSURF}/${GEOM}_${n}_tri.json
done

muse_geometry -V -p ${WP} --grid --resx 7000 --resy 7000 --obj
...
for ((n=1; n<=3; n++))
do
    muse_manipulate -E -p ${WP} --geom ${OUTSURF}/${GEOM}_${n}_tri.obj
    mv ${OUTMAN}/${GEOM}_${n}_tri.json ${OUTMAN}/${GEOM}_${n}.json
done
