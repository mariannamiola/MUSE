...
## optional override: for multi-domain examples the merged result lives
## directly in the compute folder, so sim_folder="" collapses the subpath
sim_folder = config["compute"].get("sim_folder", None)
if sim_folder is not None:
    compute_sim = sim_folder
