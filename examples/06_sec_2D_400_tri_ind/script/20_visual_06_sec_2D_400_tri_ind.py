...
project_name='06_sec_2D_400_tri_ind'
...
csv_file=script_dir+'/../../'+compute_folder+'/'+compute_sim+'/kriging.csv'
...
SaveScreenshot(directory+'/kriging.png', renderView1, FontScaling=True, OverrideColorPalette='WhiteBackground', TransparentBackground=False)
