...
project_append='190520201300_UTM'
compute_folder=compute_folder+'/'+project_append

space='/_varspace'
stats_name='mean'
sim_name=var_name+'_'+stats_name+'.csv'



csv_file1=script_dir+'/../../'+compute_folder+'/'+compute_sim1+space+'/_stats/'+sim_name
obj_file1=script_dir+'/../../'+geom_folder+'/'+geom_name+'_1.obj'

csv_file2=script_dir+'/../../'+compute_folder+'/'+compute_sim2+space+'/_stats/'+sim_name
obj_file2=script_dir+'/../../'+geom_folder+'/'+geom_name+'_2.obj'

csv_file3=script_dir+'/../../'+compute_folder+'/'+compute_sim3+space+'/_stats/'+sim_name
