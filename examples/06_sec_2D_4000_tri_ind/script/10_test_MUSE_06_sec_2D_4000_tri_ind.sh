...
then
	...
	export DATA_SOURCE=${MUSE}/examples/06_sec_2D_4000_tri_ind/data
fi
...
then
	...
	export PROJ=06_sec_2D_4000_tri_ind
fi
...
#muse_vario -V -p ${WP} -v ${VAR0} --sub ${GEOM} --vario MODEL --dir ${DIR} --dim ${DIM} --dirs 0,70,80,90,110 --degtol 15 --vclean 10
