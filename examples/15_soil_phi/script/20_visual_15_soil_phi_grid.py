...
csv_file=script_dir+'/../../MUSE_test/15_soil_phi/out/compute/P_OMNI3D_boundary_grid/_varspace/_stats/P_mean.csv'
obj_file=script_dir+'/../../MUSE_test/15_soil_phi/out/geometry/surf/boundary_grid.obj'

print(csv_file)
print(obj_file)

# create a new 'CSV Reader'
tcsv = CSVReader(registrationName='P.csv', FileName=[csv_file])
