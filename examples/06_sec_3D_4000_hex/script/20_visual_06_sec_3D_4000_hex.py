...
project_name='06_sec_3D_4000_hex'
...
grid_rotvtk = LegacyVTKReader(registrationName='grid_rot.vtk', FileNames=[vtk_file])

# create a new 'Append Attributes'
appendAttributes1 = AppendAttributes(registrationName='AppendAttributes1', Input=[grid_rotvtk, pointDatatoCellData1])
