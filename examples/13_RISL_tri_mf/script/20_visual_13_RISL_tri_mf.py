...
project_name='13_RISL_tri_mf'

var_name='EH'
sub='italy_3_t2000'
vario='DIR2D'
geom_name='italy_3_t2000'

compute_sim1=var_name+'_'+sub+'_1'+'_'+vario+'_'+geom_name+'_1'
compute_sim2=var_name+'_'+sub+'_2'+'_'+vario+'_'+geom_name+'_2'
compute_sim3=var_name+'_'+sub+'_3'+'_'+vario+'_'+geom_name+'_3'
...
italy_3_1_resobj = WavefrontOBJReader(registrationName=geom_name+'_1.obj', FileName=obj_file1)
...
# create a new 'CSV Reader'
eH_sgs_meancsv_1 = CSVReader(registrationName=sim_name+'.csv', FileName=[csv_file2])
...
# create a new 'Wavefront OBJ Reader'
italy_3_2_resobj = WavefrontOBJReader(registrationName=geom_name+'_2.obj', FileName=obj_file2)
...
# create a new 'CSV Reader'
eH_sgs_meancsv_2 = CSVReader(registrationName=sim_name+'.csv', FileName=[csv_file3])
...
# create a new 'Wavefront OBJ Reader'
italy_3_3_resobj = WavefrontOBJReader(registrationName=geom_name+'_3.obj', FileName=obj_file3)
