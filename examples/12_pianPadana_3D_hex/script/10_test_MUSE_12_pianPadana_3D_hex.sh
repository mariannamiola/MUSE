...
then
	...
	export DATA_SOURCE=${MUSE}/examples/12_pianPadana_3D_hex/data
fi
...
then
	...
	export PROJ=12_pianPadana_3D_hex
fi
...
muse_geometry -M -p ${WP} -m ${OUTSURF}/top-bottom.obj --hex --resx 1000 --resy 1000 --resz 1000 --vtk
