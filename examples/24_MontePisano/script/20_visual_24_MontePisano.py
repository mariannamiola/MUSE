...
compute_sim=var_name+'_'+sub+'_'+geom_name
...
pdf6_file=script_dir+'/../../'+compute_folder+'/'+compute_sim+'/'+pdf_name+'7.csv'
pdf7_file=script_dir+'/../../'+compute_folder+'/'+compute_sim+'/'+pdf_name+'8.csv'
...
############################## PDF_CAT1
# create a new 'CSV Reader'
pdf_cat_0csv = CSVReader(registrationName='pdf_cat_1.csv', FileName=[pdf0_file])
...
# create a new 'Append Attributes'
pdf_cat0 = AppendAttributes(registrationName='pdf_cat1', Input=[sec_rotobj, pointDatatoCellData2])


############################################## PDF_CAT2
# create a new 'CSV Reader'
pdf_cat_1csv = CSVReader(registrationName='pdf_cat_2.csv', FileName=[pdf1_file])
...
# create a new 'Append Attributes'
pdf_cat1 = AppendAttributes(registrationName='pdf_cat2', Input=[sec_rotobj, pointDatatoCellData3])



############################################## PDF_CAT3
# create a new 'CSV Reader'
pdf_cat_2csv = CSVReader(registrationName='pdf_cat_3.csv', FileName=[pdf2_file])
...
# create a new 'Append Attributes'
pdf_cat2 = AppendAttributes(registrationName='pdf_cat3', Input=[sec_rotobj, pointDatatoCellData4])



############################################## PDF_CAT4
# create a new 'CSV Reader'
pdf_cat_3csv = CSVReader(registrationName='pdf_cat_4.csv', FileName=[pdf3_file])
...
# create a new 'Append Attributes'
pdf_cat3 = AppendAttributes(registrationName='pdf_cat4', Input=[sec_rotobj, pointDatatoCellData5])


############################################## PDF_CAT5
# create a new 'CSV Reader'
pdf_cat_4csv = CSVReader(registrationName='pdf_cat_5.csv', FileName=[pdf4_file])
...
# create a new 'Append Attributes'
pdf_cat4 = AppendAttributes(registrationName='pdf_cat5', Input=[sec_rotobj, pointDatatoCellData6])


############################################## PDF_CAT6
# create a new 'CSV Reader'
pdf_cat_5csv = CSVReader(registrationName='pdf_cat_6.csv', FileName=[pdf5_file])
...
# create a new 'Append Attributes'
pdf_cat5 = AppendAttributes(registrationName='pdf_cat6', Input=[sec_rotobj, pointDatatoCellData7])


############################################## PDF_CAT7
# create a new 'CSV Reader'
pdf_cat_6csv = CSVReader(registrationName='pdf_cat_7.csv', FileName=[pdf6_file])
...
# create a new 'Append Attributes'
pdf_cat6 = AppendAttributes(registrationName='pdf_cat7', Input=[sec_rotobj, pointDatatoCellData8])

############################################## PDF_CAT8
# create a new 'CSV Reader'
pdf_cat_7csv = CSVReader(registrationName='pdf_cat_8.csv', FileName=[pdf7_file])
...
# create a new 'Append Attributes'
pdf_cat7 = AppendAttributes(registrationName='pdf_cat8', Input=[sec_rotobj, pointDatatoCellData9])
