...
project_name='07_sec_anti_2D_4000_tri'
...
phi_Dcsv = CSVReader(registrationName='phi_D.csv', FileName=[csv_file])
phi_Dcsv.HaveHeaders = 0
phi_Dcsv.FieldDelimiterCharacters = ''
phi_Dcsv.AddTabFieldDelimiter = 1
...
# create a new 'Table To Points'
tableToPoints2 = TableToPoints(registrationName='TableToPoints2', Input=phi_Dcsv)
...
D_rotobj = WavefrontOBJReader(registrationName='D_rot.obj', FileName=obj_file)

# create a new 'Append Attributes'
appendAttributes1 = AppendAttributes(registrationName='AppendAttributes1', Input=[D_rotobj, pointDatatoCellData1])
