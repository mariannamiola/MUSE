...
z_value = -4000.0  # per renderlo negativo
...
isosurfaces = contour1.Isosurfaces = [25.0, 50.0, 75.0, 100.0, 125.0, 150.0]
...
SaveScreenshot(directory+'/'+sim_name+'_sec4000.png', renderView2, FontScaling=True, OverrideColorPalette='WhiteBackground', TransparentBackground=False)
