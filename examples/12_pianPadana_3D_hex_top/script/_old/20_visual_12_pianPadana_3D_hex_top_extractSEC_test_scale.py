...
renderView3.CameraPosition = [508514.35905256, 4991352.5, 559643.2389617587]
renderView3.CameraFocalPoint = [508514.35905256, 4991352.5, -3092.0]
...
layout1_1.SetSize(1503, 779)

# create new layout object 'Layout #1'
layout1_2 = CreateLayout(name='Layout #1')
layout1_2.AssignView(0, renderView2)
layout1_2.SetSize(2152, 1140)
...
threshold1.LowerThreshold = 125.0
threshold1.UpperThreshold = 125.0
...
# create a new 'Threshold'
threshold1_1 = Threshold(registrationName='Threshold1', Input=contour1)
threshold1_1.Scalars = ['POINTS', 'Field 0']
threshold1_1.LowerThreshold = 150.0
threshold1_1.UpperThreshold = 150.0
threshold1_1.ThresholdMethod = 'Below Lower Threshold'

# create a new 'Calculator'
calculator1_1 = Calculator(registrationName='Calculator1', Input=threshold1_1)
calculator1_1.ResultArrayName = 'label1'
calculator1_1.Function = '"Field 0"'

# create a new 'Annotate Attribute Data'
annotateAttributeData1_1 = AnnotateAttributeData(registrationName='AnnotateAttributeData1', Input=calculator1_1)
annotateAttributeData1_1.SelectInputArray = ['POINTS', 'label1']
annotateAttributeData1_1.Prefix = ''

# create a new 'Threshold'
threshold1_2 = Threshold(registrationName='Threshold1', Input=contour1)
threshold1_2.Scalars = ['POINTS', 'Field 0']
threshold1_2.LowerThreshold = 100.0
threshold1_2.UpperThreshold = 100.0
threshold1_2.ThresholdMethod = 'Below Lower Threshold'

# create a new 'Calculator'
calculator1_2 = Calculator(registrationName='Calculator1', Input=threshold1_2)
calculator1_2.ResultArrayName = 'label1'
calculator1_2.Function = '"Field 0"'

# create a new 'Annotate Attribute Data'
annotateAttributeData1_2 = AnnotateAttributeData(registrationName='AnnotateAttributeData1', Input=calculator1_2)
annotateAttributeData1_2.SelectInputArray = ['POINTS', 'label1']
annotateAttributeData1_2.Prefix = ''

# create a new 'Threshold'
threshold1_3 = Threshold(registrationName='Threshold1', Input=contour1)
threshold1_3.Scalars = ['POINTS', 'Field 0']
threshold1_3.LowerThreshold = 75.0
threshold1_3.UpperThreshold = 75.0
threshold1_3.ThresholdMethod = 'Below Lower Threshold'

# create a new 'Calculator'
calculator1_3 = Calculator(registrationName='Calculator1', Input=threshold1_3)
calculator1_3.ResultArrayName = 'label1'
calculator1_3.Function = '"Field 0"'

# create a new 'Annotate Attribute Data'
annotateAttributeData1_3 = AnnotateAttributeData(registrationName='AnnotateAttributeData1', Input=calculator1_3)
annotateAttributeData1_3.SelectInputArray = ['POINTS', 'label1']
annotateAttributeData1_3.Prefix = ''

# create a new 'Threshold'
threshold1_4 = Threshold(registrationName='Threshold1', Input=contour1)
threshold1_4.Scalars = ['POINTS', 'Field 0']
threshold1_4.LowerThreshold = 25.0
threshold1_4.UpperThreshold = 25.0
threshold1_4.ThresholdMethod = 'Below Lower Threshold'

# create a new 'Calculator'
calculator1_4 = Calculator(registrationName='Calculator1', Input=threshold1_4)
calculator1_4.ResultArrayName = 'label1'
calculator1_4.Function = '"Field 0"'

# create a new 'Annotate Attribute Data'
annotateAttributeData1_4 = AnnotateAttributeData(registrationName='AnnotateAttributeData1', Input=calculator1_4)
annotateAttributeData1_4.SelectInputArray = ['POINTS', 'label1']
annotateAttributeData1_4.Prefix = ''

# create a new 'Threshold'
threshold1_5 = Threshold(registrationName='Threshold1', Input=contour1)
threshold1_5.Scalars = ['POINTS', 'Field 0']
threshold1_5.LowerThreshold = 50.0
threshold1_5.UpperThreshold = 50.0
threshold1_5.ThresholdMethod = 'Below Lower Threshold'

# create a new 'Calculator'
calculator1_5 = Calculator(registrationName='Calculator1', Input=threshold1_5)
calculator1_5.ResultArrayName = 'label1'
calculator1_5.Function = '"Field 0"'

# create a new 'Annotate Attribute Data'
annotateAttributeData1_5 = AnnotateAttributeData(registrationName='AnnotateAttributeData1', Input=calculator1_5)
annotateAttributeData1_5.SelectInputArray = ['POINTS', 'label1']
annotateAttributeData1_5.Prefix = ''
...
field0LUT.ShowCategoricalColorsinDataRangeOnly = 1
...
castelnovo1Display.Position = [0.8694420214666932, 0.33122807017543854]
...
# show data from annotateAttributeData1_1
annotateAttributeData1_1Display = Show(annotateAttributeData1_1, renderView3, 'TextSourceRepresentation')

# trace defaults for the display properties.
annotateAttributeData1_1Display.WindowLocation = 'Any Location'
annotateAttributeData1_1Display.Position = [0.8255298458179907, 0.5379032948224218]
annotateAttributeData1_1Display.Color = [0.0, 0.0, 0.0]
annotateAttributeData1_1Display.FontSize = 16
