...
renderView3.ViewSize = [1503, 779]
renderView3.InteractionMode = '2D'
renderView3.AxesGrid = 'Grid Axes 3D Actor'
renderView3.CenterOfRotation = [508514.35905256, 4991352.5, -3092.0]
renderView3.StereoType = 'Crystal Eyes'
renderView3.CameraPosition = [495440.5809181257, 4995562.699738207, 559643.2389617587]
renderView3.CameraFocalPoint = [495440.5809181257, 4995562.699738207, -3092.0]
renderView3.CameraFocalDisk = 1.0
renderView3.CameraParallelScale = 86309.09463325702
...
layout1_2.AssignView(0, renderView3)
layout1_2.SetSize(1503, 779)
...
topbottomvtk = LegacyVTKReader(registrationName='top-bottom.vtk', FileNames=['/home/mariannamiola/Devel/muse/examples/12_pianPadana_3D_hex_top/script/../../MUSE_test/12_pianPadana_3D_hex_top/out/geometry/volume/top-bottom.vtk'])
...
t_CORR_meancsv = CSVReader(registrationName='T_CORR_mean.csv', FileName=['/home/mariannamiola/Devel/muse/examples/12_pianPadana_3D_hex_top/script/../../MUSE_test/12_pianPadana_3D_hex_top/out/compute/T_DIR3Dxy_top-bottom/_varspace/_stats/T_mean.csv'])
...
# create a new 'CSV Reader'
citycsv = CSVReader(registrationName='city.csv', FileName=['/home/mariannamiola/Devel/muse/examples/12_pianPadana_3D_hex_top/script/../data/Città_Padana_NW.csv'])
citycsv.FieldDelimiterCharacters = ';'

# create a new 'Table To Points'
tableToPoints3 = TableToPoints(registrationName='TableToPoints3', Input=citycsv)
tableToPoints3.XColumn = 'X (UTM32N)'
tableToPoints3.YColumn = 'Y (UTM32N)'
tableToPoints3.ZColumn = 'Città'
...
# create a new 'CSV Reader'
samplescsv = CSVReader(registrationName='samples.csv', FileName=['/home/mariannamiola/Devel/muse/examples/12_pianPadana_3D_hex_top/script/../data/samples.csv'])
...
# create a new 'Text'
label_1 = Text(registrationName='Label_1')
label_1.Text = 'Value: 2.00'

# create a new 'Text'
text1 = Text(registrationName='Text1')

# create a new 'Text'
label_0 = Text(registrationName='Label_0')
label_0.Text = 'Value: 2.00'
...
slice1.SliceType.Origin = [508456.0, 4991050.0, -4000.0]
...
contour1.Isosurfaces = [25.0, 50.0, 75.0, 100.0, 125.0, 150.0, 175.0, 200.0]
contour1.PointMergeMethod = 'Uniform Binning'

# create a new 'Threshold'
threshold1 = Threshold(registrationName='Threshold1', Input=contour1)
threshold1.Scalars = ['POINTS', 'Field 0']
threshold1.LowerThreshold = 75.0
threshold1.UpperThreshold = 75.0
threshold1.ThresholdMethod = 'Below Lower Threshold'

# create a new 'Calculator'
calculator1 = Calculator(registrationName='Calculator1', Input=threshold1)
calculator1.ResultArrayName = 'label1'
...
annotateAttributeData1.SelectInputArray = ['POINTS', 'label1']
...
topbottomvtkDisplay = Show(topbottomvtk, renderView3, 'UnstructuredGridRepresentation')
...
tableToPoints1Display = Show(tableToPoints1, renderView3, 'GeometryRepresentation')
...
tetrahedralize1Display = Show(tetrahedralize1, renderView3, 'UnstructuredGridRepresentation')
...
pointDatatoCellData1Display = Show(pointDatatoCellData1, renderView3, 'UnstructuredGridRepresentation')
...
appendAttributes1Display = Show(appendAttributes1, renderView3, 'UnstructuredGridRepresentation')
...
tableToPoints2Display = Show(tableToPoints2, renderView3, 'GeometryRepresentation')
...
saliVercellese1Display = Show(saliVercellese1, renderView3, 'TextSourceRepresentation')
...
mortara1Display = Show(mortara1, renderView3, 'TextSourceRepresentation')
...
battuda1Display = Show(battuda1, renderView3, 'TextSourceRepresentation')
...
valleSalimbene1Display = Show(valleSalimbene1, renderView3, 'TextSourceRepresentation')
...
brignano1Display = Show(brignano1, renderView3, 'TextSourceRepresentation')
...
malossa3Display = Show(malossa3, renderView3, 'TextSourceRepresentation')
...
rodigo1Display = Show(rodigo1, renderView3, 'TextSourceRepresentation')
...
castelnovo1Display = Show(castelnovo1, renderView3, 'TextSourceRepresentation')
...
quara1Display = Show(quara1, renderView3, 'TextSourceRepresentation')
...
lamadeiCerri1Display = Show(lamadeiCerri1, renderView3, 'TextSourceRepresentation')
...
casanovaStaffora1Display = Show(casanovaStaffora1, renderView3, 'TextSourceRepresentation')
...
borgoAle1Display = Show(borgoAle1, renderView3, 'TextSourceRepresentation')
...
boscorosso1Display = Show(boscorosso1, renderView3, 'TextSourceRepresentation')
...
baiso1Display = Show(baiso1, renderView3, 'TextSourceRepresentation')
...
malpaga1Display = Show(malpaga1, renderView3, 'TextSourceRepresentation')
...
piadena1Display = Show(piadena1, renderView3, 'TextSourceRepresentation')
...
slice1Display.SetScaleArray = ['POINTS', '']
slice1Display.ScaleTransferFunction = 'Piecewise Function'
slice1Display.OpacityArray = ['POINTS', '']
...
slice1Display.SelectInputVectors = ['POINTS', '']
slice1Display.WriteLog = ''

# show data from cellDatatoPointData1
cellDatatoPointData1Display = Show(cellDatatoPointData1, renderView3, 'GeometryRepresentation')
...
cellDatatoPointData1Display.SelectInputVectors = ['POINTS', '']
...
contour1Display.LookupTable = field0LUT
...
contour1Display.SelectInputVectors = ['POINTS', '']
...
tableToPoints3Display = Show(tableToPoints3, renderView3, 'GeometryRepresentation')

# trace defaults for the display properties.
tableToPoints3Display.Representation = 'Points'
tableToPoints3Display.AmbientColor = [0.0, 0.0, 0.0]
tableToPoints3Display.ColorArrayName = ['POINTS', '']
tableToPoints3Display.DiffuseColor = [0.0, 0.0, 0.0]
...
tableToPoints3Display.TextureTransform = 'Transform2'
tableToPoints3Display.OSPRayScaleArray = 'Città'
tableToPoints3Display.OSPRayScaleFunction = 'Piecewise Function'
tableToPoints3Display.Assembly = ''
tableToPoints3Display.SelectedBlockSelectors = ['']
tableToPoints3Display.SelectOrientationVectors = 'None'
tableToPoints3Display.ScaleFactor = 23248.4
tableToPoints3Display.SelectScaleArray = 'Città'
tableToPoints3Display.GlyphType = 'Arrow'
tableToPoints3Display.GlyphTableIndexArray = 'Città'
tableToPoints3Display.GaussianRadius = 1162.42
tableToPoints3Display.SetScaleArray = ['POINTS', 'Città']
tableToPoints3Display.ScaleTransferFunction = 'Piecewise Function'
tableToPoints3Display.OpacityArray = ['POINTS', 'Città']
tableToPoints3Display.OpacityTransferFunction = 'Piecewise Function'
tableToPoints3Display.DataAxesGrid = 'Grid Axes Representation'
tableToPoints3Display.PolarAxes = 'Polar Axes Representation'
tableToPoints3Display.SelectInputVectors = ['POINTS', '']
tableToPoints3Display.WriteLog = ''

# show data from label_0
label_0Display = Show(label_0, renderView3, 'TextSourceRepresentation')

# trace defaults for the display properties.
label_0Display.WindowLocation = 'Any Location'
label_0Display.Position = [625294.2671480144, 4989388.267148014]
label_0Display.Color = [0.0, 0.0, 0.0]
label_0Display.FontSize = 16

# show data from label_1
label_1Display = Show(label_1, renderView3, 'TextSourceRepresentation')

# trace defaults for the display properties.
label_1Display.WindowLocation = 'Any Location'
label_1Display.Position = [625456.0, 4989288.0116959065]
label_1Display.Color = [0.0, 0.0, 0.0]
label_1Display.FontSize = 16
...
threshold1Display.ColorArrayName = ['POINTS', 'Field 0']
threshold1Display.LookupTable = field0LUT
...
threshold1Display.OSPRayScaleArray = 'Field 0'
...
threshold1Display.ScaleFactor = 15703.816793893133
threshold1Display.SelectScaleArray = 'Field 0'
threshold1Display.GlyphType = 'Arrow'
threshold1Display.GlyphTableIndexArray = 'Field 0'
threshold1Display.GaussianRadius = 785.1908396946566
threshold1Display.SetScaleArray = ['POINTS', 'Field 0']
threshold1Display.ScaleTransferFunction = 'Piecewise Function'
threshold1Display.OpacityArray = ['POINTS', 'Field 0']
...
threshold1Display.ScalarOpacityFunction = field0PWF
threshold1Display.ScalarOpacityUnitDistance = 28144.398355465986
threshold1Display.OpacityArrayName = ['POINTS', 'Field 0']
threshold1Display.SelectInputVectors = [None, '']
threshold1Display.WriteLog = ''

# init the 'Piecewise Function' selected for 'ScaleTransferFunction'
threshold1Display.ScaleTransferFunction.Points = [75.0, 0.0, 0.5, 0.0, 75.015625, 1.0, 0.5, 0.0]

# init the 'Piecewise Function' selected for 'OpacityTransferFunction'
threshold1Display.OpacityTransferFunction.Points = [75.0, 0.0, 0.5, 0.0, 75.015625, 1.0, 0.5, 0.0]

# show data from calculator1
calculator1Display = Show(calculator1, renderView3, 'UnstructuredGridRepresentation')

# get 2D transfer function for 'label1'
label1TF2D = GetTransferFunction2D('label1')

# get color transfer function/color map for 'label1'
label1LUT = GetColorTransferFunction('label1')
label1LUT.TransferFunction2D = label1TF2D
label1LUT.RGBPoints = [75.0, 0.231373, 0.298039, 0.752941, 75.0078125, 0.865003, 0.865003, 0.865003, 75.015625, 0.705882, 0.0156863, 0.14902]
label1LUT.ScalarRangeInitialized = 1.0

# get opacity transfer function/opacity map for 'label1'
label1PWF = GetOpacityTransferFunction('label1')
label1PWF.Points = [75.0, 0.0, 0.5, 0.0, 75.015625, 1.0, 0.5, 0.0]
label1PWF.ScalarRangeInitialized = 1

# trace defaults for the display properties.
calculator1Display.Representation = 'Surface'
calculator1Display.ColorArrayName = ['POINTS', 'label1']
calculator1Display.LookupTable = label1LUT
calculator1Display.SelectNormalArray = 'None'
calculator1Display.SelectTangentArray = 'None'
calculator1Display.SelectTCoordArray = 'None'
calculator1Display.TextureTransform = 'Transform2'
calculator1Display.OSPRayScaleArray = 'label1'
...
calculator1Display.ScaleFactor = 15703.816793893133
calculator1Display.SelectScaleArray = 'label1'
calculator1Display.GlyphType = 'Arrow'
calculator1Display.GlyphTableIndexArray = 'label1'
calculator1Display.GaussianRadius = 785.1908396946566
calculator1Display.SetScaleArray = ['POINTS', 'label1']
calculator1Display.ScaleTransferFunction = 'Piecewise Function'
calculator1Display.OpacityArray = ['POINTS', 'label1']
...
calculator1Display.ScalarOpacityFunction = label1PWF
calculator1Display.ScalarOpacityUnitDistance = 28144.398355465986
calculator1Display.OpacityArrayName = ['POINTS', 'label1']
calculator1Display.SelectInputVectors = [None, '']
calculator1Display.WriteLog = ''

# init the 'Piecewise Function' selected for 'ScaleTransferFunction'
calculator1Display.ScaleTransferFunction.Points = [75.0, 0.0, 0.5, 0.0, 75.015625, 1.0, 0.5, 0.0]

# init the 'Piecewise Function' selected for 'OpacityTransferFunction'
calculator1Display.OpacityTransferFunction.Points = [75.0, 0.0, 0.5, 0.0, 75.015625, 1.0, 0.5, 0.0]

# show data from annotateAttributeData1
annotateAttributeData1Display = Show(annotateAttributeData1, renderView3, 'TextSourceRepresentation')

# trace defaults for the display properties.
annotateAttributeData1Display.WindowLocation = 'Any Location'
annotateAttributeData1Display.Position = [0.374604125083167, 0.2133632862644416]
...
separate_contour1Display_Field0LUT.TransferFunction2D = field0TF2D
...
# get color legend/bar for separate_contour1Display_Field0LUT in view renderView3
separate_contour1Display_Field0LUTColorBar = GetScalarBar(separate_contour1Display_Field0LUT, renderView3)
...
resultLUT.RGBPoints = [75.0, 0.231373, 0.298039, 0.752941, 100.0, 0.865003, 0.865003, 0.865003, 125.0, 0.705882, 0.0156863, 0.14902]
...
# get color legend/bar for label1LUT in view renderView3
label1LUTColorBar = GetScalarBar(label1LUT, renderView3)
label1LUTColorBar.Title = 'label1'
label1LUTColorBar.ComponentTitle = ''

# set color bar visibility
label1LUTColorBar.Visibility = 1

# hide data in view
Hide(topbottomvtk, renderView3)

# hide data in view
Hide(tableToPoints1, renderView3)

# hide data in view
Hide(tetrahedralize1, renderView3)

# hide data in view
Hide(pointDatatoCellData1, renderView3)

# show color legend
appendAttributes1Display.SetScalarBarVisibility(renderView3, True)

# hide data in view
Hide(appendAttributes1, renderView3)

# show color legend
slice1Display.SetScalarBarVisibility(renderView3, True)

# hide data in view
Hide(slice1, renderView3)

# show color legend
cellDatatoPointData1Display.SetScalarBarVisibility(renderView3, True)

# show color legend
contour1Display.SetScalarBarVisibility(renderView3, True)

# show color legend
threshold1Display.SetScalarBarVisibility(renderView3, True)

# show color legend
calculator1Display.SetScalarBarVisibility(renderView3, True)
...
resultPWF.Points = [75.0, 0.0, 0.5, 0.0, 125.0, 1.0, 0.5, 0.0]
