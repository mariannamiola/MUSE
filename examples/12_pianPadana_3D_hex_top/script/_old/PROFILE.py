...
lineChartView1.ViewSize = [575, 667]
lineChartView1.LeftAxisRangeMinimum = 10.0
lineChartView1.LeftAxisRangeMaximum = 180.0
...
renderView3.ViewSize = [575, 667]
renderView3.AxesGrid = 'Grid Axes 3D Actor'
renderView3.CenterOfRotation = [508456.0, 4991050.0, -4000.0]
renderView3.StereoType = 'Crystal Eyes'
renderView3.CameraPosition = [67121.39835878575, 4659768.549327044, 100822.12150536968]
renderView3.CameraFocalPoint = [508455.9999999977, 4991049.999999994, -3999.9999999997626]
renderView3.CameraViewUp = [0.12585277025615685, 0.1429602630799527, 0.981694169993365]
renderView3.CameraViewAngle = 17.15875053487377
renderView3.CameraFocalDisk = 1.0
renderView3.CameraParallelScale = 145379.67533324595
...
layout1.AssignView(1, renderView3)
layout1.AssignView(2, lineChartView1)
layout1.SetSize(1151, 667)
...
layout1_2.AssignView(0, renderView1)
...
plotOverLine1.Resolution = 2000
plotOverLine1.Point1 = [477550.0, 5014200.0, 200.0]
plotOverLine1.Point2 = [477550.0, 5014200.0, -8000.0]
...
plotOverLine1Display.XArrayName = 'Field 0'
plotOverLine1Display.SeriesVisibility = ['Field 0']
...
field0LUT.RGBPoints = [8.28, 0.23137254902, 0.298039215686, 0.752941176471, 45.656, 0.5529411764705883, 0.6901960784313725, 0.996078431372549, 83.032, 0.8666666666666667, 0.8666666666666667, 0.8666666666666667, 120.408, 0.865, 0.865, 0.865, 157.784, 0.9568627450980393, 0.6039215686274509, 0.4823529411764706, 195.16, 0.705882352941, 0.0156862745098, 0.149019607843]
...
field0PWF.Points = [8.28, 0.0, 0.5, 0.0, 195.16, 1.0, 0.5, 0.0]
...
# show data from plotOverLine1
plotOverLine1Display_1 = Show(plotOverLine1, renderView3, 'GeometryRepresentation')
...
plotOverLine1Display_1.TextureTransform = 'Transform2'
plotOverLine1Display_1.OSPRayScaleArray = 'Field 0'
plotOverLine1Display_1.OSPRayScaleFunction = 'Piecewise Function'
plotOverLine1Display_1.Assembly = ''
plotOverLine1Display_1.SelectedBlockSelectors = ['']
plotOverLine1Display_1.SelectOrientationVectors = 'None'
plotOverLine1Display_1.ScaleFactor = 820.0
plotOverLine1Display_1.SelectScaleArray = 'Field 0'
plotOverLine1Display_1.GlyphType = 'Arrow'
plotOverLine1Display_1.GlyphTableIndexArray = 'Field 0'
plotOverLine1Display_1.GaussianRadius = 41.0
plotOverLine1Display_1.SetScaleArray = ['POINTS', 'Field 0']
plotOverLine1Display_1.ScaleTransferFunction = 'Piecewise Function'
plotOverLine1Display_1.OpacityArray = ['POINTS', 'Field 0']
plotOverLine1Display_1.OpacityTransferFunction = 'Piecewise Function'
plotOverLine1Display_1.DataAxesGrid = 'Grid Axes Representation'
plotOverLine1Display_1.PolarAxes = 'Polar Axes Representation'
plotOverLine1Display_1.SelectInputVectors = [None, '']
plotOverLine1Display_1.WriteLog = ''

# init the 'Piecewise Function' selected for 'ScaleTransferFunction'
plotOverLine1Display_1.ScaleTransferFunction.Points = [11.84, 0.0, 0.5, 0.0, 174.51, 1.0, 0.5, 0.0]

# init the 'Piecewise Function' selected for 'OpacityTransferFunction'
plotOverLine1Display_1.OpacityTransferFunction.Points = [11.84, 0.0, 0.5, 0.0, 174.51, 1.0, 0.5, 0.0]
...
field0LUTColorBar.Position = [0.0214335501858737, 0.6542233632862644]
...
# hide data in view
Hide(tableToPoints2, renderView3)
...
# initialize the animation scene
animationScene1.ViewModules = [renderView3, lineChartView1]
