...
TLUT.RGBPoints = [6.85, 0.231373, 0.298039, 0.752941, 100.425, 0.865003, 0.865003, 0.865003, 194.0, 0.705882, 0.0156863, 0.14902]
TLUT.ScalarRangeInitialized = 1.0

# trace defaults for the display properties.
tableToPoints1Display.Representation = 'Points'
tableToPoints1Display.ColorArrayName = ['POINTS', 'T']
tableToPoints1Display.LookupTable = TLUT
