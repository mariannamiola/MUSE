...
muse_geometry -P -p ${WP} --tri --polygon ${INGEOM}/${GEOM1} --opt ${OPT} --setz 10.6675 --obj
muse_geometry -P -p ${WP} --tri --polygon ${INGEOM}/${GEOM2} --opt ${OPT} --setz -1.164 --obj
muse_geometry -P -p ${WP} --tri --polygon ${INGEOM}/${GEOM3} --opt ${OPT} --setz -16.164 --obj
muse_geometry -P -p ${WP} --tri --polygon ${INGEOM}/${GEOM4} --opt ${OPT} --setz -29.356 --obj
...
for ((n=1; n<=4; n++))
do
  muse_manipulate -E -p ${WP} --geom ${OUTSURF}/${SURF}${n}.obj 
...
for ((n=1; n<=3; n++))
do
  muse_vario -V -p ${WP} -v ${VAR} --sttype ${arr[${n}-1]} -f samples_${SURF}${n} --nscore YES --dir ${DIR} --dim ${DIM} --vario MODEL --dirs 0,70,80,90,110 --degtol 15 --vclean 10 --eps 5.0 --sub ${SURF}${n}
done

muse_vario -V -p ${WP} -v ${VAR} --nscore YES --dir ${DIR} --dim ${DIM} --vario MODEL --dirs 0,70,80,90,110 --degtol 15 --vclean 10 --eps 5.0 --sub ${SURF}4
...
do
  ...
  muse_compute -C -p ${WP} -v ${VAR} --sub ${SURF}${n} -m ${OUTMAN}/${GMOD}.obj --nsim ${NSIM} --dir ${DIR} --dim ${DIM} --out ${OUTSGS} --octant --scaleradius 1.5 --input 10 --simulated 6
...
muse_compute -C -p ${WP} -v ${VAR} --sub ${SURF}4 -m ${OUTSURF}/${SURF}4.obj --nsim ${NSIM} --dir ${DIR} --dim ${DIM} --out ${OUTSGS} --octant --scaleradius 1.5 --input 10 --simulated 6
muse_compute -S -p ${WP} -v ${VAR} --sub ${SURF}4 -m ${OUTSURF}/${SURF}4.obj --dir ${DIR} --dim ${DIM} --csv
  
muse_compute -B -p ${WP} -v ${VAR} --sub ${SURF}4 -m ${OUTSURF}/${SURF}4.obj --dir ${DIR} --dim ${DIM} --extr Extr --minextr 0 --maxextr 1 --csv
  
muse_compute -S -p ${WP} -v ${VAR} --sub ${SURF}4 -m ${OUTSURF}/${SURF}4.obj --dir ${DIR} --dim ${DIM} --space VAR --csv
...
export OUTCOM4=${OUTWP}/compute/${VAR}_${SURF}4_${DIR}${DIM}_${SURF}4
