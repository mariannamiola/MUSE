...
sub=''
vario=''
geom_name='FSASSELLO_grid_FARENZANO_grid'
...
csv_file=script_dir+'/../../'+compute_folder+'/'+var_name+'_merge_grid.csv'
...
cr_merge_gridcsv = CSVReader(registrationName=var_name+'_merge_grid.csv', FileName=[csv_file])
