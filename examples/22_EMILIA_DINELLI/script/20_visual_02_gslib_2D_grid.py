...
project_name='22_EMILIA_DINELLI'
...
samplescsv_file=script_dir+'/../data/Reno_noheader.csv'

print(csv_file)
print(obj_file)

# create a new 'CSV Reader'
p_ccsv = CSVReader(registrationName=var_name+'.csv', FileName=[csv_file])
...
# create a new 'CSV Reader'
samplescsv = CSVReader(registrationName='Reno.csv', FileName=[samplescsv_file])
...
field0LUTColorBar.Title = var_name
...
p_cLUT = GetColorTransferFunction(var_name)
...
tableToPoints1Display.ColorArrayName = ['POINTS', var_name]
...
tableToPoints1Display.OSPRayScaleArray = var_name
...
tableToPoints1Display.SetScaleArray = ['POINTS', var_name]
tableToPoints1Display.ScaleTransferFunction = 'PiecewiseFunction'
tableToPoints1Display.OpacityArray = ['POINTS', var_name]
