...
project_name='04_prl_2D_poly_tri_md'
...
compute_sim1=var_name+'_'+sub+'5TERRE_tri'+'_'+vario+'_'+geom_name+'5TERRE_tri'
compute_sim2=var_name+'_'+sub+'MAGRA_tri'+'_'+vario+'_'+geom_name+'MAGRA_tri'
compute_sim3=var_name+'_'+sub+'PETRONIO_tri'+'_'+vario+'_'+geom_name+'PETRONIO_tri'
compute_sim4=var_name+'_'+sub+'PORTOFINO_tri'+'_'+vario+'_'+geom_name+'PORTOFINO_tri'
compute_sim5=var_name+'_'+sub+'ENTELLA_tri'+'_'+vario+'_'+geom_name+'ENTELLA_tri'
compute_sim6=var_name+'_'+sub+'AVETO_tri'+'_'+vario+'_'+geom_name+'AVETO_tri'
compute_sim7=var_name+'_'+sub+'PADANO_tri'+'_'+vario+'_'+geom_name+'PADANO_tri'
compute_sim8=var_name+'_'+sub+'BISAGNO_tri'+'_'+vario+'_'+geom_name+'BISAGNO_tri'
compute_sim9=var_name+'_'+sub+'POLCEVERA_tri'+'_'+vario+'_'+geom_name+'POLCEVERA_tri'
compute_sim10=var_name+'_'+sub+'ARENZANO_tri'+'_'+vario+'_'+geom_name+'ARENZANO_tri'
compute_sim11=var_name+'_'+sub+'SASSELLO_tri'+'_'+vario+'_'+geom_name+'SASSELLO_tri'
compute_sim12=var_name+'_'+sub+'BORMIDE_tri'+'_'+vario+'_'+geom_name+'BORMIDE_tri'
compute_sim13=var_name+'_'+sub+'SAVONESE_tri'+'_'+vario+'_'+geom_name+'SAVONESE_tri'
compute_sim14=var_name+'_'+sub+'IMPERIESE_tri'+'_'+vario+'_'+geom_name+'IMPERIESE_tri'
...
region1 = WavefrontOBJReader(registrationName=geom_name+'5TERRE_tri.obj', FileName=obj_file1)
...
# create a new 'Wavefront OBJ Reader'
region2 = WavefrontOBJReader(registrationName=geom_name+'MAGRA_tri.obj', FileName=obj_file2)
...
# create a new 'Wavefront OBJ Reader'
region3 = WavefrontOBJReader(registrationName=geom_name+'PETRONIO_tri.obj', FileName=obj_file3)
...
# create a new 'Wavefront OBJ Reader'
region4 = WavefrontOBJReader(registrationName=geom_name+'PORTOFINO_tri.obj', FileName=obj_file4)
...
# create a new 'Wavefront OBJ Reader'
region5 = WavefrontOBJReader(registrationName=geom_name+'ENTELLA_tri.obj', FileName=obj_file5)
...
# create a new 'Wavefront OBJ Reader'
region6 = WavefrontOBJReader(registrationName=geom_name+'AVETO_tri.obj', FileName=obj_file6)
...
# create a new 'Wavefront OBJ Reader'
region7 = WavefrontOBJReader(registrationName=geom_name+'PADANO_tri.obj', FileName=obj_file7)
...
# create a new 'Wavefront OBJ Reader'
region8 = WavefrontOBJReader(registrationName=geom_name+'BISAGNO_tri.obj', FileName=obj_file8)
...
# create a new 'Wavefront OBJ Reader'
region9 = WavefrontOBJReader(registrationName=geom_name+'PORTOFINO_tri.obj', FileName=obj_file9)
...
# create a new 'Wavefront OBJ Reader'
region10 = WavefrontOBJReader(registrationName=geom_name+'ARENZANO_tri.obj', FileName=obj_file10)
...
# create a new 'Wavefront OBJ Reader'
region11 = WavefrontOBJReader(registrationName=geom_name+'PORTOFINO_tri.obj', FileName=obj_file11)
...
# create a new 'Wavefront OBJ Reader'
region12 = WavefrontOBJReader(registrationName=geom_name+'BORMIDE_tri.obj', FileName=obj_file12)
...
# create a new 'Wavefront OBJ Reader'
region13 = WavefrontOBJReader(registrationName=geom_name+'SAVONESE_tri.obj', FileName=obj_file13)
...
# create a new 'Wavefront OBJ Reader'
region14 = WavefrontOBJReader(registrationName=geom_name+'IMPERIESE_tri.obj', FileName=obj_file14)
