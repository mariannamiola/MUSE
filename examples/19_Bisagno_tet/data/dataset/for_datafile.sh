...
#export FILENAME1_COORD=bb2_bedrock
#export FILENAME1_CAT=cat_bedrock
#export FILENAME1=log_bedrock
...
cat ${FILENAME2}.dat | sed -e 's/^   //g' | sed -e 's/^  //g' | sed -e 's/      /;/g' | sed -e 's/     /;/g' | sed -e 's/    /;/g' | sed -e 's/   /;/g' | sed -e 's/   /;-/g' | sed -e 's/  /;/g' | sed -e 's/ /;/g' > ${FILENAME2}.csv
...
cat ${HEADER}.csv ${FILENAME2}.csv ${FILENAME3}.csv ${FILENAME4}.csv > ../${FILENAME_OUT}.csv
cat ${FILENAME2}.csv ${FILENAME3}.csv ${FILENAME4}.csv > ../samples.csv
