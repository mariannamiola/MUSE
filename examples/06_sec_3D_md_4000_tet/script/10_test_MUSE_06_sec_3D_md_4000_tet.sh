...
then
	...
	export DATA_SOURCE=${MUSE}/examples/06_sec_3D_md_4000_tet/data
fi
...
then
	...
	export PROJ=06_sec_3D_md_4000_tet
fi
...
#vario:
##########  VARIO  ###########
muse_vario -V -p ${WP} -v ${VAR} --sub ${SURF1} --nscore YES --dir ${DIR} --dim ${DIM} --vario MODEL --vclean 10 --eps 5.0 --dirs 0,22.5,67.5,90,112.5 --degtol 22.5 #--weight 
