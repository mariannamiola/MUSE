...
phi_meansimcsv = CSVReader(registrationName=sim_name+'.csv', FileName=[csv_file])
...
sec_rotobj = WavefrontOBJReader(registrationName=geom_name+'_rot.obj', FileName=obj_file)
...
field0LUTColorBar.RangeLabelFormat = '%-#7.2g'
