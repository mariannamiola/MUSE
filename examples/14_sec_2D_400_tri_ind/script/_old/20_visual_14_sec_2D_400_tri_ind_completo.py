...
pdf_cat_3csv = CSVReader(registrationName='pdf_cat_3.csv', FileName=['/home/marianna/muse/examples/MUSE_test/14_sec_2D_400_tri_ind/out/compute/phi_sec_DIR2D_sec/pdf_cat_3.csv'])
...
# create a new 'CSV Reader'
pdf_cat_6csv = CSVReader(registrationName='pdf_cat_6.csv', FileName=['/home/marianna/muse/examples/MUSE_test/14_sec_2D_400_tri_ind/out/compute/phi_sec_DIR2D_sec/pdf_cat_6.csv'])
...
# create a new 'CSV Reader'
pdf_cat_4csv = CSVReader(registrationName='pdf_cat_4.csv', FileName=['/home/marianna/muse/examples/MUSE_test/14_sec_2D_400_tri_ind/out/compute/phi_sec_DIR2D_sec/pdf_cat_4.csv'])
...
# create a new 'CSV Reader'
pdf_cat_2csv = CSVReader(registrationName='pdf_cat_2.csv', FileName=['/home/marianna/muse/examples/MUSE_test/14_sec_2D_400_tri_ind/out/compute/phi_sec_DIR2D_sec/pdf_cat_2.csv'])
...
# create a new 'CSV Reader'
amga_class_v_4000copiacsv = CSVReader(registrationName='amga_class_v_4000 (copia).csv', FileName=['/home/marianna/muse/examples/14_sec_2D_400_tri_ind/data/amga_class_v_400 (copia).csv'])
...
# create a new 'CSV Reader'
pdf_cat_5csv = CSVReader(registrationName='pdf_cat_5.csv', FileName=['/home/marianna/muse/examples/MUSE_test/14_sec_2D_400_tri_ind/out/compute/phi_sec_DIR2D_sec/pdf_cat_5.csv'])
...
sec_rotobj = WavefrontOBJReader(registrationName='sec_rot.obj', FileName='/home/marianna/muse/examples/MUSE_test/14_sec_2D_400_tri_ind/out/geometry/surf/sec_rot.obj')
...
# create a new 'CSV Reader'
pdf_cat_7csv = CSVReader(registrationName='pdf_cat_7.csv', FileName=['/home/marianna/muse/examples/MUSE_test/14_sec_2D_400_tri_ind/out/compute/phi_sec_DIR2D_sec/pdf_cat_7.csv'])
...
# create a new 'CSV Reader'
pdf_cat_1csv = CSVReader(registrationName='pdf_cat_1.csv', FileName=['/home/marianna/muse/examples/MUSE_test/14_sec_2D_400_tri_ind/out/compute/phi_sec_DIR2D_sec/pdf_cat_1.csv'])
...
# create a new 'CSV Reader'
pdf_cat_0csv = CSVReader(registrationName='pdf_cat_0.csv', FileName=['/home/marianna/muse/examples/MUSE_test/14_sec_2D_400_tri_ind/out/compute/phi_sec_DIR2D_sec/pdf_cat_0.csv'])
...
# create a new 'CSV Reader'
sisimcsv = CSVReader(registrationName='sisim.csv', FileName=['/home/marianna/muse/examples/MUSE_test/14_sec_2D_400_tri_ind/out/compute/phi_sec_DIR2D_sec/sisim.csv'])
