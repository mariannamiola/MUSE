...
csv_file=script_dir+'/../../MUSE_test/16_matera_PM10_2D_tri/out/compute/PM10_OMNI3D_level1/_varspace/_stats/PM10_sgs_mean.csv'
obj_file=script_dir+'/../../MUSE_test/16_matera_PM10_2D_tri/out/geometry/surf/level1.obj'

print(csv_file)
print(obj_file)

# create a new 'CSV Reader'
tcsv = CSVReader(registrationName='PM10.csv', FileName=[csv_file])
...
nisobj = WavefrontOBJReader(registrationName='level1.obj', FileName=obj_file)
