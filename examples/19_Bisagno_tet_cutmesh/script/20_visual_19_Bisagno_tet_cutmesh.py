...
project_name='19_Bisagno_tet_cutmesh'

geom_input='bisagno_DEM_CG' ##'subDEM'##'piana-piana_dz'
var_name='cat'
...
pdf1_file=script_dir+'/../../'+compute_folder+'/'+compute_sim+'/'+pdf_name+'2.csv'
pdf2_file=script_dir+'/../../'+compute_folder+'/'+compute_sim+'/'+pdf_name+'3.csv'
pdf3_file=script_dir+'/../../'+compute_folder+'/'+compute_sim+'/'+pdf_name+'4.csv'
pdf4_file=script_dir+'/../../'+compute_folder+'/'+compute_sim+'/'+pdf_name+'5.csv'
pdf5_file=script_dir+'/../../'+compute_folder+'/'+compute_sim+'/'+pdf_name+'6.csv'
...
# create a new 'Table To Points'
top5 = TableToPoints(registrationName='tet5', Input=pdf_cat_5csv)
top5.XColumn = 'Field 0'
top5.YColumn = 'Field 0'
top5.ZColumn = 'Field 0'
top5.KeepAllDataArrays = 1

# create a new 'Triangulate'
tet5 = Tetrahedralize(registrationName='tet5', Input=top5)

# create a new 'Point Data to Cell Data'
pdcd5 = PointDatatoCellData(registrationName='pdcd5', Input=tet5)
pdcd5.PointDataArraytoprocess = ['Field 0']
pdcd5.PassPointData = 1

# create a new 'Append Attributes'
pdf_cat5 = AppendAttributes(registrationName='pdf_cat5', Input=[cubevtk, pdcd5])
...
pdf_cat5Display = Show(pdf_cat5, renderView1, 'UnstructuredGridRepresentation')

# get separate 2D transfer function for 'Field0'
separate_pdf_cat5Display_Field0TF2D = GetTransferFunction2D('Field0', pdf_cat5Display, separate=True)
separate_pdf_cat5Display_Field0TF2D.ScalarRangeInitialized = 1

# get separate color transfer function/color map for 'Field0'
separate_pdf_cat5Display_Field0LUT = GetColorTransferFunction('Field0', pdf_cat5Display, separate=True)
separate_pdf_cat5Display_Field0LUT.TransferFunction2D = separate_pdf_cat5Display_Field0TF2D
separate_pdf_cat5Display_Field0LUT.RGBPoints = [0.0, 0.231373, 0.298039, 0.752941, 0.49999999999999994, 0.865003, 0.865003, 0.865003, 1.0, 0.705882, 0.0156863, 0.14902]
...
pdf_cat5Display.OSPRayScaleFunction = 'Piecewise Function'
pdf_cat5Display.Assembly = ''
pdf_cat5Display.SelectOrientationVectors = 'None'
pdf_cat5Display.ScaleFactor = 1174.6229999999516
pdf_cat5Display.SelectScaleArray = 'None'
pdf_cat5Display.GlyphType = 'Arrow'
pdf_cat5Display.GlyphTableIndexArray = 'None'
pdf_cat5Display.GaussianRadius = 58.73114999999758
pdf_cat5Display.SetScaleArray = [None, '']
pdf_cat5Display.ScaleTransferFunction = 'Piecewise Function'
pdf_cat5Display.OpacityArray = [None, '']
pdf_cat5Display.OpacityTransferFunction = 'Piecewise Function'
pdf_cat5Display.DataAxesGrid = 'Grid Axes Representation'
pdf_cat5Display.PolarAxes = 'Polar Axes Representation'
pdf_cat5Display.ScalarOpacityFunction = separate_pdf_cat5Display_Field0PWF
pdf_cat5Display.ScalarOpacityUnitDistance = 300.23406504500673
pdf_cat5Display.OpacityArrayName = ['CELLS', 'Field 0']
pdf_cat5Display.SelectInputVectors = [None, '']
pdf_cat5Display.WriteLog = ''
...
separate_pdf_cat5Display_Field0LUTColorBar.WindowLocation = 'Any Location'
separate_pdf_cat5Display_Field0LUTColorBar.Position = [0.7435728411338166, 0.03851091142490376]
separate_pdf_cat5Display_Field0LUTColorBar.Title = 'Field 0'
separate_pdf_cat5Display_Field0LUTColorBar.ComponentTitle = ''
separate_pdf_cat5Display_Field0LUTColorBar.ScalarBarLength = 0.32999999999999996
