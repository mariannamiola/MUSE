...
muse_vario -V -p ${WP} -v ${VAR1} --sub ${GEOM} --nscore YES --dir ${DIR} --dim ${DIM} --vario MODEL --dirs 0,70,80,90,110 --degtol 15 --vclean 10 --eps 5.0

#computesgs:
##########  COMPUTE  ###########
muse_compute -C -p ${WP} -v ${VAR1} --sub ${GEOM} -m ${OUTSURF}/${GEOM}.obj --nsim ${NSIM} --dir ${DIR} --dim ${DIM} --out ${OUTSGS} --octant --scaleradius 1.5 --input 10 --simulated 6
muse_compute -S -p ${WP} -v ${VAR1} --sub ${GEOM} -m ${OUTSURF}/${GEOM}.obj --dir ${DIR} --dim ${DIM} --csv
muse_compute -B -p ${WP} -v ${VAR1} --sub ${GEOM} -m ${OUTSURF}/${GEOM}.obj --dir ${DIR} --dim ${DIM} --extr Extr --minextr 0 --maxextr 1 --csv
muse_compute -S -p ${WP} -v ${VAR1} --sub ${GEOM} -m ${OUTSURF}/${GEOM}.obj --dir ${DIR} --dim ${DIM} --space VAR --csv
...
#variosis:
##########  VARIO  ###########
muse_vario -V -p ${WP} -v ${VAR2} --sub ${GEOM} --vario MODEL --dir ${DIR} --dim ${DIM} --dirs 0,70,80,90,110 --degtol 15 --vclean 10 --itype SPHERICAL!6 --itype SPHERICAL!8 --inugget 0!1 --inugget 0!2 --inugget 0!3 --inugget 0!4 --inugget 0!5 --inugget 0!6 --inugget 0!7 --inugget 0!8

#computesis:
##########  COMPUTE  ###########
#read -p "SIS ... Press any key to continue ... " -n1 -s

muse_compute -C -p ${WP} -v ${VAR2} --sub ${GEOM} --dir ${DIR} --dim ${DIM} -m ${OUTSURF}/${GEOM}.obj --crit SISIM --nsim ${NSIM} --scaleradius 1.5 --octant --simulated 6 --input 10
