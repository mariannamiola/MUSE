...
project_name='12_pianPadana_3D_hex_top_rev'
...
tableToPoints1.XColumn = 'east'
tableToPoints1.YColumn = 'north'
tableToPoints1.ZColumn = 'height'
...
# get color transfer function/color map for 'T_CORR'
t_CORRLUT = GetColorTransferFunction('T_CORR')
t_CORRLUT.RGBPoints = [6.85, 0.231373, 0.298039, 0.752941, 100.425, 0.865003, 0.865003, 0.865003, 194.0, 0.705882, 0.0156863, 0.14902]
t_CORRLUT.ScalarRangeInitialized = 1.0

# trace defaults for the display properties.
tableToPoints1Display.Representation = 'Points'
tableToPoints1Display.ColorArrayName = ['POINTS', 'T_CORR']
tableToPoints1Display.LookupTable = t_CORRLUT
...
tableToPoints1Display.OSPRayScaleArray = 'T_CORR'
...
tableToPoints1Display.SetScaleArray = ['POINTS', 'T_CORR']
tableToPoints1Display.ScaleTransferFunction = 'PiecewiseFunction'
tableToPoints1Display.OpacityArray = ['POINTS', 'T_CORR']
