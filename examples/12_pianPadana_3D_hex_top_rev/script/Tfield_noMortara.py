...
renderView1.ViewSize = [1683, 1055]
renderView1.AxesGrid = 'GridAxes3DActor'
renderView1.CenterOfRotation = [538890.5, 5009263.5, -17570.0]
renderView1.StereoType = 'Crystal Eyes'
renderView1.CameraPosition = [657082.6546117918, 4630752.971157165, 147922.58781664734]
renderView1.CameraFocalPoint = [538890.5, 5009263.5, -17570.0]
renderView1.CameraViewUp = [-0.3009285005174955, 0.30158787561122286, 0.9047025980180456]
renderView1.CameraFocalDisk = 1.0
renderView1.CameraParallelScale = 111210.12026214162
renderView1.BackEnd = 'OSPRay raycaster'
renderView1.OSPRayMaterialLibrary = materialLibrary1

# init the 'GridAxes3DActor' selected for 'AxesGrid'
renderView1.AxesGrid.Visibility = 1
renderView1.AxesGrid.DataScale = [1.0, 1.0, 5.0]
...
topbottomvtk = LegacyVTKReader(registrationName='top-bottom.vtk', FileNames=['/home/marianna/muse/examples/MUSE_test/12_pianPadana_3D_hex_top_rev/out/geometry/volume/top-bottom.vtk'])
...
t_meancsv = CSVReader(registrationName='T_mean_rev010824.csv', FileName=['/home/marianna/muse/examples/MUSE_test/12_pianPadana_3D_hex_top_rev/out/compute/T_CORR_DIR3Dxy_top-bottom/_varspace/_stats/T_CORR_mean_p_stdev.csv'])
...
cellDatatoPointData5.CellDataArraytoprocess = ['Field 0', 'hex_selector']
...
cellDatatoPointData4.CellDataArraytoprocess = ['Field 0', 'hex_selector']
...
cellDatatoPointData6.CellDataArraytoprocess = ['Field 0', 'hex_selector']
...
cellDatatoPointData7.CellDataArraytoprocess = ['Field 0', 'hex_selector']
...
cellDatatoPointData3.CellDataArraytoprocess = ['Field 0', 'hex_selector']
