...
then
	...
	export DATA_SOURCE=${MUSE}/examples/12_pianPadana_3D_tet/data
fi
...
then
	...
	export PROJ=12_pianPadana_3D_tet
fi
...
muse_geometry -O -p ${WP} -m ${OUTSURF}/${GEOM}.obj --abs -z 942 --obj ##-165
mv ${OUTSURF}/${GEOM}_absz.obj ${OUTSURF}/top.obj
mv ${OUTSURF}/${GEOM}_absz.json ${OUTSURF}/top.json

muse_geometry -O -p ${WP} -m ${OUTSURF}/${GEOM}.obj --abs -z -7200 --obj
mv ${OUTSURF}/${GEOM}_absz.obj ${OUTSURF}/bottom.obj
mv ${OUTSURF}/${GEOM}_absz.json ${OUTSURF}/bottom.json

muse_geometry -T -p ${WP} -m ${OUTSURF}/top.obj -m ${OUTSURF}/bottom.obj --obj

muse_geometry -M -p ${WP} -m ${OUTSURF}/top-bottom.obj --tet --opt Yq1.2/20 --vtk
...
#muse_vario -V -p ${WP} -v ${VAR} --nscore YES --dim 1Dz --vario MODEL --eps 5.0
